package com.mustafak01.foundoutbackendrestaurants.mernis;
...
public class KPSPublicSoap
{
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new RAMIWcfMethod()
        {
            @Override
    ...
    protected java.lang.Object execute(RAMIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
